...
from .graph_memory_provider import create_graph_memory_provider
...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        """设置图谱本体（公开方法）"""
        self.provider.set_ontology(graph_ids=[graph_id], ontology=ontology)
    ...
    def add_text_batches(
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            # 发送到图谱记忆 provider
            try:
                batch_result = self.provider.add_text_batch(graph_id=graph_id, texts=batch_chunks)
    ...
    def _wait_for_episodes(
        ...
        while pending_episodes:
            ...
            for ep_uuid in list(pending_episodes):
                try:
                    episode = self.provider.get_episode(ep_uuid)
